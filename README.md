...
- Interface claire et moderne : design cohérent avec ton identité visuelle, pensé pour la simplicité.  
- Légèreté et performance : optimisée pour fonctionner même sur des appareils plus anciens.  
- Installation directe via APK : rapide, simple, sans dépendances externes.
...
- Foreground service : protection en temps réel  

<p align="center">
Chaque permission est expliquée dans l’application avant activation.</p>
...
- Intégration d’un mode expert  

---

🤝 Contribution ouvertes :  
- Améliorations UI/UX  
- Modules d’analyse  
- Optimisations  
- Documentation  
